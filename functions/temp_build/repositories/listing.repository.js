...
exports.listingRepository = {
    ...
    getAllActive: function (filters) { return __awaiter(void 0, void 0, void 0, function () {
        var ref, snapshot, docs, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    ref = firebase_1.db.collection("listings");
                ...
                case 1:
                    ...
                    logger.debug("[ListingRepo] Retrieved ".concat(docs.length, " listings"), filters || {});
                    return [2 /*return*/, docs];
                case 2:
                    error_1 = _a.sent();
                    console.error("Repo Error getAllActive:", error_1);
                    return [2 /*return*/, []];
    ...
    getById: function (id) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, firebase_1.db.collection("listings").doc(id).get()];
                case 1:
                    doc = _a.sent();
                    if (!doc.exists)
                ...
                case 2:
                    error_2 = _a.sent();
                    console.error("Repo Error getById:", error_2);
                    return [2 /*return*/, null];
                case 3: return [2 /*return*/];
            }
        });
