...
async function seedTaxis() {
    console.log('🚕 Starting Taxi Listings Seeding...');
    console.log(`📱 All taxis configured with: ${TEST_TAXI_PHONE}\n`);
    let kyreniaTaxis = 0;
    let nicosiaTaxis = 0;
    ...
    for (const taxi of taxiListings) {
        ...
        console.log(`✅ Created: ${taxi.title}`);
        console.log(`   📍 Location: ${taxi.location} (${taxi.city})`);
        console.log(`   🚗 Vehicle: ${taxi.vehicleColor} ${taxi.vehicleModel} (${taxi.plateNumber})`);
        console.log(`   💰 Base rate: ${taxi.price} ${taxi.currency}`);
        console.log(`   ⭐ Rating: ${taxi.rating}/5`);
    ...
    console.log('✅ ✅ ✅ Taxi Seeding Complete!\n');
    console.log('📊 Summary:');
    console.log(`   Total Taxis: ${taxiListings.length}`);
    console.log(`   - Kyrenia: ${kyreniaTaxis} taxis`);
    console.log(`   - Nicosia: ${nicosiaTaxis} taxis`);
    console.log(`   - Famagusta: ${famagustasTaxis} taxis`);
    console.log(`   - Iskele: ${iskeleTaxis} taxis`);
    console.log(`\n📱 All taxis use: ${TEST_TAXI_PHONE}`);
    console.log('\n🎯 The dispatchTaxi tool will now randomly select from these taxis based on:');
    console.log('   - domain: "Cars"');
    console.log('   - type: "taxi"');
    console.log('   - location proximity (future enhancement)');
