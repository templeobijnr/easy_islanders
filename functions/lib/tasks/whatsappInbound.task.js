...
exports.processWhatsAppInbound = functions.tasks.onTaskDispatched(QUEUE_OPTIONS, async (req) => {
    ...
    try {
        ...
        logger.error('[WhatsAppTask] Failed', { messageSid, error: (error === null || error === void 0 ? void 0 : error.message) || error });
        await (0, whatsappInbound_repository_1.markFailed)(messageSid, (error === null || error === void 0 ? void 0 : error.message) || String(error));
