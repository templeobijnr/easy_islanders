...
async function callHeadlessScraper(request) {
    ...
    try {
        ...
        log_1.log.error('[HeadlessScraper] Error', { error: e.message });
        const timedOut = ((_a = e.message) === null || _a === void 0 ? void 0 : _a.includes('timeout')) || ((_b = e.message) === null || _b === void 0 ? void 0 : _b.includes('Timeout'));
        return {
