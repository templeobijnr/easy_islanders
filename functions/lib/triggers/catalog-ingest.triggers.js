...
exports.onCatalogIngestJobCreated = (0, firestore_1.onDocumentCreated)({
    ...
    try {
        ...
        log_1.log.error('[CatalogIngest] ❌ Job failed', error, { marketId, jobId, errorMessage: error === null || error === void 0 ? void 0 : error.message });
        await jobRef.set({ status: 'failed', error: (error === null || error === void 0 ? void 0 : error.message) || 'Unknown error', updatedAt: now }, { merge: true });
    }
});
