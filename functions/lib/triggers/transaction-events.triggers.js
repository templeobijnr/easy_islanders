...
async function handleConfirmedEvent(tx, eventData, businessId, txId, eventId) {
    ...
    if (customerPhone) {
        ...
        try {
            ...
            logger.error(`[TxEvent] Failed to send customer WhatsApp:`, err.message);
    ...
    try {
        ...
        logger.error(`[TxEvent] Failed to send business notification:`, err.message);
    }
}
/**
...
async function handleCancelledEvent(tx, eventData, businessId, txId, eventId) {
    ...
    try {
        ...
        logger.error(`[TxEvent] Failed to send cancellation notification:`, err.message);
    }
}
/**
...
async function handleExpiredEvent(tx, _eventData, businessId, txId, eventId) {
    ...
    try {
        ...
        logger.error(`[TxEvent] Failed to send expiry notification:`, err.message);
    }
}
