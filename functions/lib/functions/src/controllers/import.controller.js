    ...
    try {
        ...
        $("img").each((_, el) => {
            ...
            if (src) {
                ...
                const isNotIcon = !src.includes("logo") &&
                    !src.includes("icon") &&
                    !src.includes("avatar");
                if (absoluteUrl &&
                    isLargeEnough &&
        ...
        const validTitle = (ogTitle === null || ogTitle === void 0 ? void 0 : ogTitle.trim()) && !isProtectionPage("", ogTitle)
            ? ogTitle.trim()
            : undefined;
        ...
        console.error("❌ [Scrape] Error:", (0, errors_1.getErrorMessage)(error));
        return null;
    }
};
    ...
    try {
      ...
      `;
            try {
                ...
                if (start !== -1 && end !== -1) {
                    ...
                    if (isValidTitle || isValidPrice || isValidDescription) {
                        aiData = Object.assign(Object.assign({}, parsed), { 
                            ...
                            price: Number(parsed.price) || null, bedrooms: Number(parsed.bedrooms) || 1, bathrooms: Number(parsed.bathrooms) || 1, squareMeters: parsed.squareMeters
                                ? Number(parsed.squareMeters)
                                : null, plotSize: parsed.plotSize ? Number(parsed.plotSize) : null, buildYear: parsed.buildYear
                                ? Number(parsed.buildYear)
                                : new Date().getFullYear(), cleaningFee: parsed.cleaningFee
                                ? Number(parsed.cleaningFee)
                                : null, monthlyDeposit: parsed.monthlyDeposit
                ...
                console.error("🔴 [AI] Error:", (0, errors_1.getErrorMessage)(error));
        ...
        const merged = {
            ...
            description: aiData.description ||
                (scraped === null || scraped === void 0 ? void 0 : scraped.description) ||
            ...
            amenities: [
                ...(aiData.amenities || []),
                ...((scrapedAny === null || scrapedAny === void 0 ? void 0 : scrapedAny.amenities) || []),
        ...
        console.error("🔴 [Import] Error:", (0, errors_1.getErrorMessage)(error));
        res.status(500).json({
            error: "Failed to import property",
            details: (0, errors_1.getErrorMessage)(error),
        });
    }
};
