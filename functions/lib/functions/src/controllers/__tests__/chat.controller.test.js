...
// Test Helpers
// ============================================================================
const createMockRequest = (overrides = {}) => (Object.assign({ body: {
        message: 'Hello',
        agentId: 'merve',
        language: 'en',
        sessionId: 'session-123'
    }, user: { uid: 'user-123', email: 'test@example.com' } }, overrides));
...
describe('Chat Controller', () => {
    ...
    describe('handleChatMessage', () => {
        describe('Request Validation', () => {
            it('should handle valid chat request', async () => {
                ...
                await (0, chat_controller_1.handleChatMessage)(req, res);
    ...
    describe('reindexListings', () => {
        it('should handle reindex request', async () => {
            ...
            try {
                await (0, chat_controller_1.reindexListings)(req, res);
            }
            catch (e) {
...
//# sourceMappingURL=chat.controller.test.js.map