...
const listProducts = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to list products', message: (0, errors_1.getErrorMessage)(error) });
    }
};
...
const getProduct = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to get product', message: (0, errors_1.getErrorMessage)(error) });
    }
};
...
const createProduct = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to create product', message: (0, errors_1.getErrorMessage)(error) });
    }
};
...
const updateProduct = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to update product', message: (0, errors_1.getErrorMessage)(error) });
    }
};
...
const deleteProduct = async (req, res) => {
    try {
        ...
        res.status(500).json({ error: 'Failed to delete product', message: (0, errors_1.getErrorMessage)(error) });
    }
};
