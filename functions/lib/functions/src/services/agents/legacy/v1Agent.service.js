...
// PLACES & DISCOVERY
// ============================================================================
async function searchPlaces(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'searchPlaces');
    try {
        let places;
        if (params.featured) {
...
async function searchActivities(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'searchActivities');
    try {
        let activities;
        if (params.placeId) {
...
// HOUSING
// ============================================================================
async function searchHousingListings(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'searchHousingListings');
    try {
...
async function createHousingRequest(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'createHousingRequest');
...
// CAR RENTAL
// ============================================================================
async function searchCarRentalListings(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'searchCarRentalListings');
    try {
...
async function createCarRentalRequest(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'createCarRentalRequest');
    const userId = ctx.userId;
    if (!userId) {
        return { success: false, error: 'User authentication required' };
    }
...
// SERVICES & SUPPLIES
// ============================================================================
async function createServiceRequest(ctx, params) {
    const cityId = (0, toolContext_1.requireToolMarketId)(ctx, 'createServiceRequest');
    const userId = ctx.userId;
    if (!userId) {
        return { success: false, error: 'User authentication required' };
    }
