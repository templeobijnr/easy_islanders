...
exports.userTools = {
    ...
    getUserProfile: async (_args, userIdOrContext) => {
        ...
        try {
            ...
            return {
                success: false,
                error: (0, errors_1.getErrorMessage)(err) || 'Failed to get user profile'
            };
        }
    },
    /**
    ...
    updateUserProfile: async (args, userIdOrContext) => {
        ...
        try {
            ...
            return {
                success: false,
                error: (0, errors_1.getErrorMessage)(err) || 'Failed to update profile'
            };
        }
    },
    /**
    ...
    saveFavoriteItem: async (args, userIdOrContext) => {
        ...
        try {
            ...
            return {
                success: false,
                error: (0, errors_1.getErrorMessage)(err) || 'Failed to save favorite'
            };
        }
    },
    /**
    ...
    listFavorites: async (_args, userIdOrContext) => {
        ...
        try {
            ...
            return {
                success: false,
                error: (0, errors_1.getErrorMessage)(err) || 'Failed to list favorites'
            };
        }
    }
};
