...
exports.claimAdmin = exports.emailWebhook = exports.twilioStatus = exports.twilioWebhook = exports.googlePlacesProxy = exports.populate = exports.reindex = exports.jobsApi = exports.apiV1 = exports.api = void 0;
...
exports.jobsApi = (0, https_1.onRequest)({
    region: "europe-west1",
    memory: "512MiB",
    cors: true,
}, api_1.apiApp);
...
__exportStar(require("./scheduled/jobTimeout.scheduled"), exports);
...
exports.reindex = (0, https_1.onRequest)({
    ...
    var _a;
    (_a = req.app) === null || _a === void 0 ? void 0 : _a.set("trust proxy", true);
    await runMiddleware(req, res, rateLimiter_1.apiLimiter);
    if (res.headersSent)
        return;
    await runMiddleware(req, res, requireAdmin_1.requireAdmin);
    if (res.headersSent)
        return;
    return (0, chat_controller_1.reindexListings)(req, res);
});
...
exports.populate = (0, https_1.onRequest)({
    ...
    if (res.headersSent)
        return;
    return (0, populate_controller_1.populateDatabase)(req, res);
});
...
}, (req, res) => (0, twilio_controller_1.handleIncomingWhatsApp)(req, res));
...
exports.twilioStatus = (0, https_1.onRequest)({
    ...
    cors: false,
    secrets: ["TWILIO_AUTH_TOKEN"],
}, (req, res) => (0, twilio_controller_1.handleMessageStatus)(req, res));
...
}, (req, res) => (0, emailWebhook_controller_1.handleEmailWebhook)(req, res));
...
exports.claimAdmin = (0, https_1.onRequest)({
    ...
    memory: "256MiB",
    cors: true,
}, (req, res) => (0, admin_controller_1.claimAdminRole)(req, res));
