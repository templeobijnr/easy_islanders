...
describe('Business Repository', () => {
    ...
    describe('getById', () => {
        it('should return business when found', async () => {
            ...
            const result = await businessRepository.getById('business123');

            expect(result).toEqual({ id: 'business123', ...mockBusiness });
        ...
        it('should return null when not found', async () => {
            ...
            const result = await businessRepository.getById('nonexistent');
    ...
    describe('getByOwnerUid', () => {
        it('should return business owned by user', async () => {
            ...
            const result = await businessRepository.getByOwnerUid('user123');

            expect(result).toEqual({ id: 'business456', ...mockBusiness });
        ...
        it('should return null when user owns no business', async () => {
            ...
            const result = await businessRepository.getByOwnerUid('userWithNoBusiness');
    ...
    describe('startClaim', () => {
        it('should successfully start claim for unclaimed business', async () => {
            ...
            const result = await businessRepository.startClaim('business789', 'claimingUser');
        ...
        it('should reject claim for already claimed business', async () => {
            ...
            const result = await businessRepository.startClaim('business_claimed', 'newUser');
        ...
        it('should reject claim for inactive business', async () => {
            ...
            const result = await businessRepository.startClaim('deleted_business', 'user');
        ...
        it('should reject claim when another user has pending claim', async () => {
            const futureTime = Timestamp.fromMillis(Date.now() + 600000); // 10 minutes from now
            ...
            const result = await businessRepository.startClaim('pending_business', 'newUser');
        ...
        it('should allow claim when pending claim has expired', async () => {
            const pastTime = Timestamp.fromMillis(Date.now() - 600000); // 10 minutes ago
            ...
            const result = await businessRepository.startClaim('expired_pending', 'newUser');
    ...
    describe('isMember', () => {
        it('should return true for active member', async () => {
            ...
            const result = await businessRepository.isMember('business123', 'user456');
        ...
        it('should return false for non-member', async () => {
            ...
            const result = await businessRepository.isMember('business123', 'nonMember');
