...
export async function sendWhatsApp(to: string, body: string) {
    ...
    try {
        ...
        console.error('⚠️ [WhatsApp] Failed to persist outbound message log:', (err as any)?.message || err);
    }
...
export async function sendTaxiRequest(to: string, payload: {
...
export async function sendViewingRequest(to: string, payload: {
    listingTitle: string;
    listingId: string;
    customerName: string;
    customerContact: string;
...
export async function sendBookingConfirmation(to: string, payload: {
    bookingId: string;
    itemTitle: string;
    customerName: string;
    checkIn?: string;
...
export async function sendGeneralInquiry(to: string, payload: {
    subject: string;
    message: string;
    customerName?: string;
    customerContact?: string;
