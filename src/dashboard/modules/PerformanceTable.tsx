            ...
            {listings.length > 0 ? listings.map((l) => {
              ...
              return (
                <tr key={l.id} className="hover:bg-slate-50/80 transition-colors group cursor-pointer">
                  ...
                  <td className="px-6 py-4">
                     <div className="flex flex-col items-start gap-1.5">
                        ...
                        <span className={`px-2 py-0.5 rounded-md text-[10px] font-bold uppercase border ${
                            l.rentalType === 'project' ? 'bg-purple-50 text-purple-700 border-purple-100' :
                  ...
                  {/* PRICE */}
                  <td className="px-6 py-4 text-right">
                     <div className="font-mono text-sm font-bold text-slate-900">£{l.price.toLocaleString()}</div>
