/**
 * LocationPicker - Shared UI component for map + address search
 *
 * Pure UI component for selecting a location with:
    ...
    return (
        <div className="space-y-4" ref={containerRef}>
            ...
            <div className={`${height} rounded-xl overflow-hidden`}>
                <MapMini lat={value.lat} lng={value.lng} onChange={handleMapChange} />
            </div>
