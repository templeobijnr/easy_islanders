                    ...
                    {step === 'details' ? (
                        <>
                            <div className="mb-auto">
                                ...
                                <div className="text-3xl font-bold text-slate-900 mb-6">{formatMoney(listing.price)}</div>
                        ...
                        <div className="animate-in slide-in-from-right-4">
                            ...
                            <div className="bg-slate-50 p-4 rounded-xl mb-6">
                                <div className="flex justify-between mb-2 text-sm">
                                    ...
                                    <span className="font-bold">{formatMoney((listing.price ?? 0) * quantity)}</span>
                                </div>
                                <div className="flex justify-between mb-2 text-sm">
                                ...
                                <div className="border-t border-slate-200 pt-2 flex justify-between font-bold text-lg">
                                    <span>Total</span>
                                    <span>{formatMoney((listing.price ?? 0) * quantity)}</span>
                                </div>
                            </div>
