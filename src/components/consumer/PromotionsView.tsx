      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto">
            Hand-picked offers from top island businesses. Subscribe to
            categories to get notified.
          </p>
        </div>
              ...
              <div className="space-y-3">
                {subscriptions.map((sub) => (
                  ...
                  >
                    ...
                    >
                      <div
                        className={`w-4 h-4 bg-white rounded-full absolute top-1 transition-all ${sub.isSubscribed ? "left-5" : "left-1"}`}
                      ></div>
                    </button>
                  </div>
                ))}
            ...
            {filteredPromos.length > 0 ? (
              ...
              <div className="text-center py-20 bg-white rounded-3xl border border-slate-100">
                ...
                <p className="text-slate-500">
                  Check back later for new promotions in this category.
                </p>
              </div>
            )}
          </div>
